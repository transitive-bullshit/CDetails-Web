...
ASSET_VERSION   = 0
#utils.shell("cd %s && make version" % PROJ_ROOT)[0]

ADMINS = (
    ('Travis', 'fisch0920@gmail.com'), 
)
...
SECRET_KEY = '3whjm6l=^ut&u=2n@f!%#&ds^1s!dqrylkvw2x&x_@g^rhsiub'
...
TEMPLATE_DIR = os.path.join(PROJ_ROOT, "html")
